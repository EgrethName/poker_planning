...
urlpatterns = [
    ...
    re_path(r'(?P<sess_id>\S+)/new_vote', views.create_vote_session, name='create_vote_session'),
    re_path(r'(?P<sess_id>\S+)/users', views.get_all_users, name='get_all_users'),
    re_path(r'(?P<sess_id>\S+)/votes_sessions', views.get_session_votes, name='get_session_votes'),
    ...
    re_path(r'(?P<sess_id>\S+)/end_vote', views.end_vote_session, name='end_vote_session'),
    re_path(r'(?P<sess_id>\S+)/info', views.info, name='info'),
